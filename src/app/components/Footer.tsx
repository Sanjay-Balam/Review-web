        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-[var(--light-text)] hover:text-[var(--secondary-color)]">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/menu" className="text-[var(--light-text)] hover:text-[var(--secondary-color)]">
                  Our Menu
                </Link>
              </li>
              <li>
                <Link href="/reviews" className="text-[var(--light-text)] hover:text-[var(--secondary-color)]">
                  Reviews
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-[var(--light-text)] hover:text-[var(--secondary-color)]">
                  Contact
                </Link>
              </li>
            </ul>
